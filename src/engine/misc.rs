...
pub fn create_video_subsystem(sdl_context: &sdl2::Sdl)
  -> Result<sdl2::VideoSubsystem, String> {
...
pub fn create_window(video_subsystem: &sdl2::VideoSubsystem)
  -> Result<(sdl2::video::Window, sdl2::video::GLContext), String> {
  let window = video_subsystem
    .window("SMT Nocturne Memory Editor 1.3", 950, 675)
    .allow_highdpi()
    .opengl()
    .position_centered()
    .build()
...
pub fn create_imgui() -> Result<imgui::Context, String> {
  ...
  imgui.fonts()
    .add_font(&[imgui::FontSource::TtfData {
      data: &bytes, size_pixels: 18.0, config: None
    }]);
